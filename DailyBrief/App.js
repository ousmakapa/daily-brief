...
const TOPICS = {
  ai: {
    ...
    requireTerms: ['openai', 'anthropic', 'gemini', 'chatgpt', 'gpt', 'llm', 'deepmind', 'claude', 'mistral', 'sora', 'dall-e', 'stable diffusion', 'midjourney', 'ai model', 'artificial intelligence', 'machine learning', 'nvidia', 'hugging face'],
    importanceCriteria: 'Score 80-100: new model launches, real capability announcements, product releases from major labs (OpenAI, Anthropic, Google, Meta, Mistral), major research breakthroughs, funding rounds above $100M, significant safety findings. Score 0-20: opinion on what AI might do someday, tutorials, listicles, generic "AI is changing X" takes, anything without a named product or concrete event.',
    prompt:
      'Summarize the top AI news today in 3-4 engaging sentences. Focus on the most concrete and impactful developments.',
  },
  nba: {
    label: 'NBA',
    emoji: '🏀',
    ...
    requireTerms: ['nba', 'basketball'],
    importanceCriteria: 'Score 80-100: confirmed trades, star player injuries or returns, playoff game results with key stats, major contract signings, coaching changes, breaking news from credible reporters. Score 0-20: fantasy basketball advice, generic power rankings, bench player minor news, recycled analysis, game previews without new information.',
    prompt:
      'Summarize the top NBA news today in 3-4 engaging sentences. Include key trades, injuries, or playoff results.',
  },
  padel: {
    label: 'Padel',
    emoji: '🎾',
    ...
    requireTerms: ['padel'],
    importanceCriteria: 'Score 80-100: Premier Padel tournament draws and results, world ranking changes, top player news or transfers, rule changes, new equipment releases from major brands. Score 0-20: beginner technique tips, local club openings, generic padel lifestyle content, events not involving top-ranked players.',
    prompt:
      'Summarize the top padel news today in 3-4 engaging sentences. Include tournament results, player news, or ranking updates.',
  },
  shoes: {
    label: 'Sneakers',
    emoji: '👟',
    ...
    requireTerms: ['nike', 'adidas', 'jordan', 'sneaker', 'shoe', 'new balance', 'hoka', 'asics', 'yeezy', 'air max', 'dunk', 'collab', 'restock', 'drop', 'release'],
    importanceCriteria: 'Score 80-100: confirmed release dates with prices, official collab announcements, limited drop details, restock alerts, new silhouette reveals from major brands. Score 0-20: "best sneakers for X" style guides, vague brand stories without a specific product, generic fashion roundups, old releases being re-covered.',
    prompt:
      'Summarize the top sneaker news today in 3-4 sentences. Cover major drops, collabs, and releases.',
  },
  biz: {
    label: 'Business',
    emoji: '💼',
    ...
    importanceCriteria: 'Score 80-100: platform algorithm changes affecting reach or revenue, new tools with real performance data or case studies with numbers, major ecommerce policy changes, creator monetization updates, concrete consumer behavior shifts with data. Score 0-20: "10 tips for X" articles, motivational content, vague trend reports with no data, any advice that could have been written 2 years ago, stock market news.',
    prompt:
      'Summarize practical business growth news. Cover sales, ecommerce, branding, content marketing, AI tools, and the creator economy. Focus on what is new and actionable.',
  },
  viral: {
    label: 'Viral',
    emoji: '🔥',
    ...
    requireTerms: ['viral', 'tiktok', 'instagram', 'youtube', 'creator', 'campaign', 'trend', 'views', 'reel', 'short'],
    importanceCriteria: 'Score 80-100: specific campaigns with real view or engagement numbers, new platform features that change how content spreads, creator strategies proven to drive virality, brand campaigns that broke through with a measurable result. Score 0-20: generic "how to go viral" advice, opinion on what might trend, recycled trend reports, anything without a specific example or number.',
    prompt:
      'Summarize the most interesting viral moments, creator trends, and standout campaigns. Explain what made them spread and what someone can actually learn from it.',
  },
  dent: {
    label: 'Dentistry',
    emoji: '🦷',
    ...
    requireTerms: ['dent', 'oral', 'tooth', 'teeth', 'gum', 'orthodon', 'implant', 'cavity', 'enamel', 'jaw', 'periodon'],
    importanceCriteria: 'Score 80-100: published clinical studies with concrete findings, FDA or CE approved treatments or devices, breakthrough research, significant new technology entering the market. Score 0-20: generic brushing and flossing tips, practice management advice, hospital PR without clinical data, content a dentist already knows.',
    prompt:
      'Summarize the most important dentistry and oral health news today. Focus on research, new treatments, and technology.',
  },
  arch: {
    label: 'Architecture',
    emoji: '🏛️',
    ...
    requireTerms: ['architect', 'building', 'design', 'urban', 'construct', 'facade', 'studio', 'tower', 'housing', 'pritzker', 'dezeen', 'archdaily'],
    importanceCriteria: 'Score 80-100: iconic or landmark project completions or reveals, major awards (Pritzker, RIBA, etc.), significant urban planning decisions, innovative construction methods or materials making news, work by globally recognized architects. Score 0-20: interior decoration tips, small residential renovations, generic "design trends" listicles, local projects with no broader significance.',
    prompt:
      'Summarize the top architecture and design news today. Focus on notable projects, awards, and ideas worth knowing.',
  },
  med: {
    label: 'Medicine',
    emoji: '⚕️',
    ...
    importanceCriteria: 'Score 80-100: peer-reviewed study results with clear findings, FDA approvals of new drugs or devices, major clinical trial outcomes, public health developments that affect daily life, breakthroughs in treatment for common conditions. Score 0-20: "doctors say drink water" wellness fluff, hospital PR without data, unnamed expert opinion, generic health advice anyone already knows.',
    prompt:
      'Summarize the most important medicine and health news today. Focus on research findings, approvals, and developments that affect how people live or get treated.',
  },
  supp: {
    label: 'Supplements',
    emoji: '💪',
    ...
    requireTerms: ['supplement', 'protein', 'creatine', 'vitamin', 'whey', 'pre-workout', 'preworkout', 'amino', 'collagen', 'omega', 'nutrition', 'nutraceutical', 'sports nutrition'],
    importanceCriteria: 'Score 80-100: new RCT or meta-analysis results with named compounds and effect sizes, safety warnings or recalls, new formulations with clinical backing, regulatory updates affecting the supplement industry. Score 0-20: brand-sponsored content, vague health claims without studies, "best supplements for X" listicles, anything that reads like an ad.',
    prompt:
      'Summarize the most credible supplement and sports nutrition news today. Focus on actual research findings, safety, and new developments.',
  },
  perf: {
    ...
    requireTerms: ['meta ads', 'google ads', 'tiktok ads', 'paid ads', 'paid social', 'performance marketing', 'roas', 'cac', 'cpm', 'ctr', 'advantage+', 'performance max', 'attribution', 'ad spend', 'campaign'],
    importanceCriteria: 'Score 80-100: Meta, Google, or TikTok platform changes to ad delivery or targeting, new ad formats launched, algorithm changes affecting campaign performance, real ROAS or CPM benchmark data, attribution or tracking updates (iOS, cookieless). Score 0-20: generic "how to run ads" guides, agency blog posts with no new data, opinion pieces, content that could have been written anytime in the last 3 years.',
    prompt:
      'Summarize the most important performance marketing news today. Focus on platform changes, new formats, and real data that affects ad operators.',
  },
  higgs: {
    label: 'Higgsfield',
    emoji: '🎬',
    ...
    feeds: [
      'https://news.google.com/rss/search?q=Higgsfield+AI&hl=en-US&gl=US&ceid=US:en',
      'https://news.google.com/rss/search?q=Higgsfield+Soul+Try+On&hl=en-US&gl=US&ceid=US:en',
      'https://news.google.com/rss/search?q=Higgsfield+AI+video+camera&hl=en-US&gl=US&ceid=US:en',
      'https://news.google.com/rss/search?q=%22Higgsfield%22&hl=en-US&gl=US&ceid=US:en',
    ],
    requireTerms: ['higgsfield'],
    prompt:
      'Summarize the latest Higgsfield AI news. Focus on product updates, new features, creator use cases, and company announcements.',
  },
};
...
function sortArticlesByLocalImportance(articles) {
  return [...articles].sort((a, b) => {
    const scoreA = articleQualityScore(a) + (a.relatedCount || 1) * 35;
    const scoreB = articleQualityScore(b) + (b.relatedCount || 1) * 35;
...
export default function App() {
  ...
  async function fetchTopic(topicKey, currentData = data, apiKey = savedKey) {
    ...
    try {
      ...
      let articles = chooseBestRelatedArticles(results
        ...
        .filter((a) => {
          ...
          if (topic.requireTerms?.length && !topic.requireTerms.some((term) => haystack.includes(term.toLowerCase()))) {
            return false;
          }
          return true;
        }));
  ...
  async function rankArticlesByImportance(topic, articles, apiKey) {
    ...
    for (let offset = 0; offset < articles.length; offset += CHUNK) {
      ...
      const articleBlock = batch.map((a, i) =>
        ...
        const resp = await fetch('https://api.openai.com/v1/chat/completions', {
          ...
          body: JSON.stringify({
            ...
            messages: [
              ...
              {
                role: 'user',
                content: `Topic: ${topic.label}\nImportance criteria: ${topic.importanceCriteria || topic.prompt}\n\nArticles:\n${articleBlock}`,
              },
            ],
          }),
        });
